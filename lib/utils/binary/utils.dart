...
class BytesUtils {
  ...
  static String toBinary(List<int> dataBytes, {int zeroPadBitLen = 0}) {
    return BigintUtils.toBinary(BigintUtils.fromBytes(dataBytes), zeroPadBitLen);
  }
  ...
  ///
  static String? tryToHexString(List<int>? dataBytes, {bool lowerCase = true, String? prefix}) {
