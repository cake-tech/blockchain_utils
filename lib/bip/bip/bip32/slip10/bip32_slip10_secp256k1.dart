...
/// working with Bip32Slip10Secp256k1 keys. It is used for key derivation and
/// management within the SECP256K1 curve.
///
/// Constructors:
/// - [Bip32Slip10Secp256k1] constructor for creating an instance with provided key data.
/// - [Bip32Slip10Secp256k1.fromSeed] constructor for creating a key from a seed.
/// - [Bip32Slip10Secp256k1.fromPrivateKey] constructor for creating a key from a private key.
/// - [Bip32Slip10Secp256k1.fromPublicKey] constructor for creating a key from a public key.
/// - [Bip32Slip10Secp256k1.fromExtendedKey] constructor for creating a key from an extended key string.
///
/// This class is specific to the SECP256K1 curve and provides necessary methods for
...
class Bip32Slip10Secp256k1 extends Bip32Base {
  ...
  Bip32Slip10Secp256k1.fromPrivateKey(List<int> privKey,
      {Bip32KeyData? keyData, Bip32KeyNetVersions? keyNetVer})
