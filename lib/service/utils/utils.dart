...
class ServiceProviderUtils {
  ...
  static String? findError({Object? object, required int statusCode, List<int>? allowStatusCode}) {
    String? error;
  ...
  static Map<String, dynamic> findErrorDetails({Object? object, required int statusCode}) {
    String? error;
  ...
  static bool isSuccessStatusCode(int statusCode, {List<int>? allowSuccessStatusCodes}) {
  ...
  ///
  /// Returns: The parsed response as an object of type `T`.
  static T parseResponse<T>({required Object? object, required BaseServiceRequestParams params}) {
    try {
      ...
      if (<Map<String, dynamic>>[] is T) {
        ...
        return (object as List).map((e) => (e as Map).cast<String, dynamic>()).toList() as T;
      }
      if (<int>[] is T) {
        if (object is List<int>) {
